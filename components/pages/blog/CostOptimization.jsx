...
export default function CostOptimization() {
  return (
    ...
    >
      ...
      <h2>The Displacement Economics</h2>
      <p>
      ...
      <p><strong>The math is simple: Even a 10% displacement with FMPE or FMPP can result in substantial monthly savings.</strong></p>

      <h2>The 'Free' Benefits</h2>
      <p>
        Cost reduction is the primary driver, but CaCO₃ brings secondary performance benefits that further improve your ROI:
      </p>
      <ol>
        <li><strong>Reduced Energy Consumption</strong> — Higher thermal conductivity leads to faster heating and cooling, reducing the energy required per ton of output.</li>
        <li><strong>Increased Throughput</strong> — Faster cooling often allows for higher line speeds and increased hourly output.</li>
        <li><strong>Anti-Blocking Properties</strong> — In film applications, the filler acts as a natural anti-block, reducing the need for expensive specialty additives.</li>
      </ol>

      <h2>The 20% Challenge</h2>
      <p>
