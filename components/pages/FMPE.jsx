...
const FMPE_INDUSTRIES = [
  ...
  { image: '/images/industries cards/consumer_good.png',name: 'Consumer Goods',                                               desc: 'Household film products, carrier bags, and bin liners. FMPE delivers the cost reduction and opacity needed for high-volume commodity applications.',               tags: ['Carrier Bags', 'Bin Liners', 'Household Film'] },
]
