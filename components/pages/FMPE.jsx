          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 80, alignItems: 'start' }} id="fmpe-intro-grid">
            ...
            >
              <div style={{ fontFamily: 'Inter, sans-serif', fontSize: 12, fontWeight: 800, letterSpacing: '0.08em', textTransform: 'uppercase', color: '#D4840A', border: '1px solid rgba(212,132,10,0.3)', borderRadius: 4, padding: '5px 14px', display: 'inline-block', marginBottom: 16 }}>
                <T>What Is PE Filler Masterbatch?</T>
              </div>
              <h2 style={{ fontFamily: 'Inter, sans-serif', fontSize: 'clamp(22px, 2.5vw, 34px)', fontWeight: 900, letterSpacing: '-0.02em', lineHeight: 1.15, marginBottom: 20, color: '#141B3E' }}>
                <T>CaCO₃ Concentrate on PE Carrier</T>
              </h2>
              <p style={{ fontSize: 16, color: 'rgba(20,27,62,0.65)', lineHeight: 1.85, marginBottom: 18 }}>
                <T>PE filler masterbatch is a concentrated compound of calcium carbonate (CaCO₃) dispersed in a polyethylene carrier resin. It is blended into blown film, cast film, extrusion, and injection moulding lines to partially replace virgin polymer — reducing raw material cost while maintaining key mechanical properties.</T>
              </p>
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8, marginBottom: 28 }}>
                {KEY_SPECS.map(s => (
                  <span key={s} style={{ fontFamily: 'Inter, sans-serif', fontSize: 12, fontWeight: 700, padding: '5px 12px', borderRadius: 5, background: 'rgba(212,132,10,0.07)', border: '1px solid rgba(212,132,10,0.2)', color: '#A86508' }}><T>{s}</T></span>
                ))}
              </div>
              <p style={{ fontSize: 16, color: 'rgba(20,27,62,0.65)', lineHeight: 1.85 }}>
                <T>CaCO₃ loadings of 70–80% allow flexible let-down ratios, giving processors direct control over film weight, opacity, and stiffness. All grades are manufactured at our in-house facility in the 6th of October industrial zone, Egypt.</T>
              </p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 24 }}
            ...
            >
              <div style={{ background: '#F7F8FC', border: '1px solid rgba(20,27,62,0.08)', borderRadius: 14, padding: '28px 28px 24px' }}>
                <div style={{ fontFamily: 'Inter, sans-serif', fontSize: 12, fontWeight: 800, letterSpacing: '0.08em', textTransform: 'uppercase', color: '#D4840A', marginBottom: 10 }}><T>In-House Production</T></div>
                <h3 style={{ fontFamily: 'Inter, sans-serif', fontSize: 17, fontWeight: 900, color: '#141B3E', letterSpacing: '-0.01em', lineHeight: 1.3, marginBottom: 12 }}><T>Quality at Every Batch</T></h3>
                <p style={{ fontSize: 15, color: 'rgba(20,27,62,0.6)', lineHeight: 1.8 }}>
                  <T>Each batch is tested for MFI, ash content, colour, and CaCO₃ dispersion before dispatch. Full traceability from raw mineral intake to finished goods — CoA and TDS provided on every shipment.</T>
                </p>
              </div>
            </motion.div>
          </div>
      ...
      <section id="grades" style={{ background: '#F7F8FC', padding: '80px 48px' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          ...
          >
            ...
            >
              <div>
                <div style={{ fontFamily: 'Inter, sans-serif', fontSize: 12, fontWeight: 800, letterSpacing: '0.08em', textTransform: 'uppercase', color: '#D4840A', border: '1px solid rgba(212,132,10,0.35)', borderRadius: 4, padding: '4px 12px', display: 'inline-block', marginBottom: 8 }}><T>Grade Reference</T></div>
                ...
                <p style={{ fontFamily: 'Open Sans, sans-serif', fontSize: 14, color: 'rgba(20,27,62,0.55)', margin: 0, fontWeight: 400 }}><T>Standard range shown — custom CaCO₃ loadings, carrier systems, and application-specific formulations available on request.</T></p>
              </div>
              ...
              {gradesOpen && (
                ...
                >
                  <div style={{ paddingTop: 24 }}>
                    <p style={{ fontSize: 14, color: 'rgba(20,27,62,0.6)', lineHeight: 1.8, maxWidth: 620, marginBottom: 32 }}><T>The grades below represent our standard PE filler masterbatch range. Additional CaCO₃ loadings, custom carrier systems, and application-specific formulations are available on request. All grades supplied with TDS and CoA. </T><strong style={{ color: '#141B3E' }}><T>Contact us to discuss your specific requirement.</T></strong></p>
            ...
            <div style={{ background: '#FFFFFF', border: '1px solid rgba(20,27,62,0.08)', borderRadius: 14, overflow: 'hidden', marginBottom: 40 }}>
              ...
              {GRADES.map((g, i) => (
                ...
                >
                  ...
                  <div style={{ fontFamily: 'Inter, sans-serif', fontSize: 13, fontWeight: 800, color: '#D4840A' }}><T>{g.loading}</T></div>
                  <div style={{ fontSize: 12, color: 'rgba(20,27,62,0.6)' }}><T>{g.dosage}</T></div>
                  <div style={{ fontSize: 12, color: 'rgba(20,27,62,0.6)' }}><T>{g.mfi}</T></div>
                  <div style={{ fontSize: 12, color: 'rgba(20,27,62,0.6)' }}><T>{g.apps}</T></div>
                </div>
              ))}
            </div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '14px 20px', background: 'rgba(212,132,10,0.05)', border: '1px solid rgba(212,132,10,0.2)', borderRadius: 10, marginBottom: 32 }}>
              ...
              <p style={{ fontSize: 13, color: 'rgba(20,27,62,0.65)', lineHeight: 1.6 }}>
                <T>Custom CaCO₃ loadings, particle sizes, and carrier blends are available for specific processing requirements. </T><strong style={{ color: '#D4840A' }}><T>Contact us to discuss your application.</T></strong>
              </p>
            </div>
                  </div>
                </motion.div>
      ...
      <section style={{ background: '#F7F8FC', padding: '72px 48px 0', borderTop: '1px solid rgba(20,27,62,0.08)' }}>
        <div ref={indRef} style={{ maxWidth: 1200, margin: '0 auto' }}>
          ...
          >
            ...
            <h2 style={{ fontFamily: 'Inter, sans-serif', fontSize: 'clamp(22px, 2.5vw, 34px)', fontWeight: 900, letterSpacing: '-0.02em', marginBottom: 10, color: '#141B3E' }}><T>Where FMPE Filler Masterbatch Is Used</T></h2>
            <p style={{ fontSize: 14, color: 'rgba(20,27,62,0.6)', lineHeight: 1.8, maxWidth: 520 }}><T>FMPE grades are used across the full range of PE film and extrusion applications — wherever CaCO₃ loading delivers cost and performance advantages.</T></p>
          </motion.div>
      ...
      <section id="quote-form" ref={formRef} style={{ background: '#F7F8FC', padding: '0 48px 96px' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          ...
          >
            ...
            <h2 style={{ fontFamily: 'Inter, sans-serif', fontSize: 'clamp(22px, 2.5vw, 34px)', fontWeight: 900, letterSpacing: '-0.02em', marginBottom: 8, color: '#141B3E' }}><T>Get FMPE Series Pricing</T></h2>
