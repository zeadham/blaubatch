...
const FMPP_INDUSTRIES = [
  ...
  { image: '/images/industries cards/packaging.png',     name: 'BOPP & Cast Film',                                     desc: 'Biaxially oriented and cast PP film for packaging and lamination. FMPP improves film stiffness and reduces cost in high-output cast film lines.',                                       tags: ['BOPP Film', 'Cast Film', 'Lamination'] },
  { image: '/images/industries cards/consumer_goods.png',name: 'Injection Moulding',                                   desc: 'PP household articles, caps, closures, and industrial components. FMPP at lower dosage rates reduces material cost while maintaining surface quality.',                                   tags: ['Caps & Closures', 'Household Items', 'Industrial Parts'] },
]
