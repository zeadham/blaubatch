...
const baseMetadata = {
  ...
  alternates: {
    canonical: BASE_URL,
    languages: { en: BASE_URL, ar: `${BASE_URL}/ar`, 'x-default': BASE_URL },
  },
  openGraph: {
    type: 'website',
    locale: 'en_US',
  ...
  '@graph': [
    {
      ...
      logo: {
        '@type': 'ImageObject',
        url: `${BASE_URL}/logo-mark-navy.png`,
      },
      contactPoint: {
        '@type': 'ContactPoint',
...
export async function generateMetadata({ params }) {
  ...
  if (lang !== 'ar') return baseMetadata
  return {
    ...baseMetadata,
    title: { default: AR_TITLE, template: '%s | بلاو باتش' },
    description: AR_DESC,
    alternates: { canonical: `${BASE_URL}/ar`, languages: { en: BASE_URL, ar: `${BASE_URL}/ar` } },
    openGraph: { ...baseMetadata.openGraph, locale: 'ar_EG', url: `${BASE_URL}/ar`, title: AR_TITLE, description: AR_DESC },
    twitter: { ...baseMetadata.twitter, title: AR_TITLE, description: AR_DESC },
  }
}
...
export default async function RootLayout({ children, params }) {
  ...
  return (
    <html lang={lang} dir={isRTL(lang) ? 'rtl' : 'ltr'}>
      ...
      <body>
        <LocaleProvider lang={lang} dict={isAr ? AR_DICT : null}>
          <a href="#main-content" className="skip-link">{isAr ? 'انتقل إلى المحتوى' : 'Skip to content'}</a>
          <Navbar />
